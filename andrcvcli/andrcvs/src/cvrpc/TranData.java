...
;
    ...
    public opencv_rpc_args setIn_data(byte[] in_data) {
      setIn_data(in_data == null ? (ByteBuffer)null : ByteBuffer.wrap(in_data));
      return this;
    }
...
;
    ...
    public image_match_args setImg_data(byte[] img_data) {
      setImg_data(img_data == null ? (ByteBuffer)null : ByteBuffer.wrap(img_data));
      return this;
    }
