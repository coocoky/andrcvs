...
//@Generated(value = "Autogenerated by Thrift Compiler (0.9.2)", date = "2015-4-30")
public class TranData {
  ...
  public interface Iface {
    ...
    public ByteBuffer read_image(String file_hash, Map<String,String> pa) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void read_image(String file_hash, Map<String,String> pa, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_read_image(String file_hash, Map<String,String> pa) throws org.apache.thrift.TException
    {
      read_image_args args = new read_image_args();
      args.setFile_hash(file_hash);
      args.setPa(pa);
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void read_image(String file_hash, Map<String,String> pa, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      read_image_call method_call = new read_image_call(file_hash, pa, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class read_image_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public read_image_call(String file_hash, Map<String,String> pa, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class read_image<I extends Iface> extends org.apache.thrift.ProcessFunction<I, read_image_args> {
      ...
      public read_image_result getResult(I iface, read_image_args args) throws org.apache.thrift.TException {
        read_image_result result = new read_image_result();
        result.success = iface.read_image(args.file_hash, args.pa);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class read_image<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, read_image_args, ByteBuffer> {
      ...
      public void start(I iface, read_image_args args, org.apache.thrift.async.AsyncMethodCallback<ByteBuffer> resultHandler) throws TException {
        iface.read_image(args.file_hash, args.pa,resultHandler);
      }
    }
  ...
  public static class read_image_args implements org.apache.thrift.TBase<read_image_args, read_image_args._Fields>, java.io.Serializable, Cloneable, Comparable<read_image_args>   {
    ...
    private static final org.apache.thrift.protocol.TField FILE_HASH_FIELD_DESC = new org.apache.thrift.protocol.TField("file_hash", org.apache.thrift.protocol.TType.STRING, (short)1);
    ...
    public String file_hash; // required
    public Map<String,String> pa; // required

    /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      FILE_HASH((short)1, "file_hash"),
      PA((short)2, "pa");
    ...
    static {
      Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
      tmpMap.put(_Fields.FILE_HASH, new org.apache.thrift.meta_data.FieldMetaData("file_hash", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
      tmpMap.put(_Fields.PA, new org.apache.thrift.meta_data.FieldMetaData("pa", org.apache.thrift.TFieldRequirementType.DEFAULT, 
    ...
    public read_image_args setFile_hash(String file_hash) {
      this.file_hash = file_hash;
      return this;
    }

    public void unsetFile_hash() {
      this.file_hash = null;
    }

    /** Returns true if field file_hash is set (has been assigned a value) and false otherwise */
    public boolean isSetFile_hash() {
      return this.file_hash != null;
    }

    public void setFile_hashIsSet(boolean value) {
      if (!value) {
        this.file_hash = null;
      }
    }
    ...
    public boolean equals(read_image_args that) {
      ...
      boolean this_present_file_hash = true && this.isSetFile_hash();
      boolean that_present_file_hash = true && that.isSetFile_hash();
      if (this_present_file_hash || that_present_file_hash) {
        if (!(this_present_file_hash && that_present_file_hash))
          return false;
        if (!this.file_hash.equals(that.file_hash))
          return false;
      }
    ...
    public int hashCode() {
      ...
      boolean present_file_hash = true && (isSetFile_hash());
      list.add(present_file_hash);
      if (present_file_hash)
        list.add(file_hash);
    ...
    public int compareTo(read_image_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetFile_hash()).compareTo(other.isSetFile_hash());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetFile_hash()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.file_hash, other.file_hash);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    private static class read_image_argsStandardScheme extends StandardScheme<read_image_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, read_image_args struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 1: // FILE_HASH
              if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
                struct.file_hash = iprot.readString();
                struct.setFile_hashIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
              }
              break;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, read_image_args struct) throws org.apache.thrift.TException {
        ...
        oprot.writeStructBegin(STRUCT_DESC);
        if (struct.file_hash != null) {
          oprot.writeFieldBegin(FILE_HASH_FIELD_DESC);
          oprot.writeString(struct.file_hash);
          oprot.writeFieldEnd();
        }
        if (struct.pa != null) {
          oprot.writeFieldBegin(PA_FIELD_DESC);
